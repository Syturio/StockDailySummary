...
function updateDeployment(tr) {
    assert(tr.stdOutContained('Successfullyupdateddeploymenthistory http://MOCK_SCM_WEBSITE/api/deployments/MOCK_DEPLOYMENT_ID'), 'Should have printed: Successfullyupdateddeploymenthistory http://MOCK_SCM_WEBSITE/api/deployments/MOCK_DEPLOYMENT_ID');
    assert(tr.stdOutContained('Failedtoupdatedeploymenthistory null (CODE: 501)'), 'Should have printed: Failedtoupdatedeploymenthistory null (CODE: 501)');
}
function getContinuousJobs(tr) {
    ...
    assert(tr.stdOutContained('Error: FailedToGetContinuousWebJobs null (CODE: 501)'), 'Should have printed: Error: FailedToGetContinuousWebJobs null (CODE: 501)');
}
function startContinuousWebJob(tr) {
    assert(tr.stdOutContained('StartedWebJob MOCK_JOB_NAME'), 'Should have printed: StartedWebJob MOCK_JOB_NAME');
    assert(tr.stdOutContained('FailedToStartContinuousWebJob MOCK_JOB_NAME null (CODE: 501)'), 'Should have printed: FailedToStartContinuousWebJob MOCK_JOB_NAME null (CODE: 501)');
}
function stopContinuousWebJob(tr) {
    assert(tr.stdOutContained('StoppedWebJob MOCK_JOB_NAME'), 'StoppedWebJob MOCK_JOB_NAME');
    assert(tr.stdOutContained('FailedToStopContinuousWebJob MOCK_JOB_NAME null (CODE: 501)'), 'Should have printed: FailedToStopContinuousWebJob MOCK_JOB_NAME null (CODE: 501)');
}
function installSiteExtension(tr) {
    assert(tr.stdOutContained('SiteExtensionInstalled MOCK_EXTENSION'), 'Should have printed: SiteExtensionInstalled MOCK_EXTENSION');
    assert(tr.stdOutContained('FailedToInstallSiteExtension MOCK_EXTENSION null (CODE: 501)'), 'Should have printed: FailedToInstallSiteExtension MOCK_EXTENSION null (CODE: 501)');
}
function getSiteExtensions(tr) {
    ...
    assert(tr.stdOutContained('FailedToGetSiteExtensions null (CODE: 501)'), 'Should have printed: FailedToGetSiteExtensions null (CODE: 501)');
}
function getAllSiteExtensions(tr) {
    ...
    assert(tr.stdOutContained('FailedToGetAllSiteExtensions null (CODE: 501)'), 'Should have printed: FailedToGetAllSiteExtensions null (CODE: 501)');
}
...
function getAppSettings(tr) {
    ...
    assert(tr.stdOutContained('FailedToFetchKuduAppSettings null (CODE: 501)'), 'Should have printed: FailedToFetchKuduAppSettings null (CODE: 501)');
}
function listDir(tr) {
    ...
    assert(tr.stdOutContained('FailedToListPath site/wwwroot null (CODE: 501)'), 'Should have printed: FailedToListPath site/wwwroot null (CODE: 501)');
}
function getFileContent(tr) {
    ...
    assert(tr.stdOutContained('FailedToGetFileContent site/wwwroot web.config null (CODE: 501)'), 'Should have printed: FailedToGetFileContent site/wwwroot web.config null (CODE: 501)');
}
function uploadFile(tr) {
    ...
    assert(tr.stdOutContained('FailedToUploadFile site/wwwroot web.config null (CODE: 501)'), 'Should have printed: FailedToUploadFile site/wwwroot web.config null (CODE: 501)');
}
function createPath(tr) {
    ...
    assert(tr.stdOutContained('FailedToCreatePath site/wwwroot null (CODE: 501)'), 'Should have printed: FailedToCreatePath site/wwwroot null (CODE: 501)');
}
...
function extractZIP(tr) {
    ...
    assert(tr.stdOutContained('Failedtodeploywebapppackageusingkuduservice null (CODE: 501)'), 'Should have printed: Failedtodeploywebapppackageusingkuduservice null (CODE: 501)');
}
function deleteFile(tr) {
    assert(tr.stdOutContained('KUDU DELETE FILE PASSED'), 'Should have printed: KUDU DELETE FILE PASSED');
    assert(tr.stdOutContained('FailedToDeleteFile site/wwwroot web.config null (CODE: 501)'), 'Should have printed: Error: FailedToDeleteFile site/wwwroot web.config null (CODE: 501)');
}
